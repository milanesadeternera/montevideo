...
//Cargamos los mapas
//SEGMENTO I02490
const imagelayers = new ol.layer.Group({
	layers: [
		new ol.layer.GeoImage({
	name: 'I02490_0.jpg',
	source: new ol.source.GeoImage({
	url: "./maplayers/I02490_0.jpg",
...
function update() {
    ...
    imagelayers.setOpacity(opacity);
  }
